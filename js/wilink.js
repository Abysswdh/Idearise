document.addEventListener("DOMContentLoaded", () => {
  const comments = [
    {
      id: 1,
      text: "Ini nih! Aplikasi anti ribet, fitur 5 aplikasi dijadikan 1! mantap",
      likes: 14,
    ...
    {
      id: 2,
      text: "Memang perkembangan smart home harus dilarasi dengan pengembangan aplikasi seperti ini. Thank you inovasinya!",
      likes: 20,
      time: getRandomPastDate(30),
      user: {
        name: "Satria Pratama",
